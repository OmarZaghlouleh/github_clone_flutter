...
class AppRouter {
  ...
  static Future<dynamic> navigateTo({required BuildContext context, required Widget destination,}) {
    return Navigator.of(context).push<Object>(
        MaterialPageRoute(builder: (context) => destination,)
    );
  }

  static Future<dynamic> navigateRemoveTo({required BuildContext context, required Widget destination,}) {
  ...
  static Future<dynamic> navigateReplacementTo({required BuildContext context, required Widget destination,}) {
  print('replaceee');
  ...
  static navigateByGlobalNavigatorKey(Widget classToNavigate,) {
