...
checkInternetApp() {
  ...
  connectionChangeStream = connectionStatus.connectionChange.listen((isOnline) {
    if (isOnline) {
      ...
      connectionStatus.startConnect == false
          ? showSimpleNotification(
              Text(
                "تم استعادة الاتصال بالانترنيت",
